...
const Sale = sequelize.define("sales", {
  ...
  discount_value: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0.0 },
  discount_amount: { type: DataTypes.DECIMAL(14, 2), defaultValue: 0.0 },
  taxable_amount: { type: DataTypes.DECIMAL(14, 2), defaultValue: 0.0 },
  tax_rate: { type: DataTypes.DECIMAL(5, 2), defaultValue: 0.0 },
  tax_amount: { type: DataTypes.DECIMAL(14, 2), defaultValue: 0.0 },
  total_amount: { type: DataTypes.DECIMAL(14, 2), allowNull: false },
  amount_tendered: { type: DataTypes.DECIMAL(14, 2), defaultValue: 0.0 },
  change_amount: { type: DataTypes.DECIMAL(14, 2), defaultValue: 0.0 },
